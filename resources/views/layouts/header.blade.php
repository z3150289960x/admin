...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/layui/css/pages-JD-index.css" />
    <link rel="stylesheet" type="text/css" href="/layui/css/widget-jquery.autocomplete.css" />
    <link rel="stylesheet" type="text/css" href="/layui/css/widget-cartPanelView.css" />
</head>
                    ...
                    <div class="tbar-panel-main">
                        <div class="tbar-panel-content J-panel-content">
                            <div class="jt-history-wrap">
                                <ul>
                                    <!--<li class="jth-item">
                                        <a href="#" class="img-wrap"> <img src=".portal//layui/img/like_03.png" height="100" width="100" /> </a>
                                        <a class="add-cart-button" href="#" target="_blank">加入购物车</a>
                                        <a href="#" target="_blank" class="price">￥498.00</a>
                                    </li>
                                    <li class="jth-item">
                                        <a href="#" class="img-wrap"> <img src="portal//layui/img/like_02.png" height="100" width="100" /></a>
                                        <a class="add-cart-button" href="#" target="_blank">加入购物车</a>
                                        <a href="#" target="_blank" class="price">￥498.00</a>
                                    </li>-->
                                </ul>
...
<script type="text/javascript" src="/layui/js/model/cartModel.js"></script>
<script type="text/javascript" src="/layui/js/czFunction.js"></script>
...
<script type="text/javascript" src="/layui/js/pages/index.js"></script>
<script type="text/javascript" src="/layui/js/widget/cartPanelView.js"></script>
