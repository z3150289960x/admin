...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/layui/css/pages-register.css" />
</head>
...
<body>
	<div class="register py-container ">
		...
		<div class="registerArea">
			...
			<div class="info">
				<form class="sui-form form-horizontal" action="{{url('login1')}}" method="post">
					@csrf
					<div class="control-group">
						<label class="control-label">用户名：</label>
						<div class="controls">
							<input type="text" placeholder="请输入你的用户名" name="login_name" class="input-xfat input-xlarge">
						</div>
					</div>
					<div class="control-group">
						<label for="inputPassword" class="control-label">登录密码：</label>
						<div class="controls">
							<input type="password" placeholder="设置登录密码" name="pwd" class="input-xfat input-xlarge">
						</div>
					</div>
					<div class="control-group">
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" placeholder="请输入你的手机号" name="cellphone" class="input-xfat input-xlarge">
						</div>
					</div>
					<div class="control-group">
					...
					<div class="control-group">
						...
						<div class="controls">
							<input  type="checkbox" value="2" checked=""><span>同意协议并注册《品优购用户协议》</span>
						</div>
					</div>
					<div class="control-group">
						...
						<div class="controls btn-reg">
							...
							{{--<a class="sui-btn btn-block btn-xlarge btn-danger" href="{{url('login1')}}" target="_blank">完成注册</a>--}}
						</div>
					</div>
				</form>
...
<script type="text/javascript" src="/layui/js/pages/register.js"></script>
</body>
